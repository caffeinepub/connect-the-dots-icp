...
export function EditResourceDialog({ open, onOpenChange, resource }: EditResourceDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateResource.mutateAsync({ id: resource.id, name, description, url });
